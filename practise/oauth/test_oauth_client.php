 ...
 */
	 ...
	 */
	$client->client_id = 'e7fe0eb1-1524-46e0-b75c-299d49f69b1e';

	/* OAuth client secret
	 * Set this to values defined by the OAuth server for your application
	 */
	$client->client_secret = 'V2FiiMEnACRhjL5jwz0woDE7pEZF4DKpnzTC0QlDGN2z0nGOoJkn0bTjY-Oet--hMD9tXsj4VCr444hOgH-U0A';
